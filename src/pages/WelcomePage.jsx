...
const WelcomePage = () => {
      ...
      try {
        ...
        const response = await fetch('/api/auth/chefs', {
          ...
          headers: {
            ...
            'Authorization': `Bearer ${token}`, // Added for authenticated chef access
          },
        });
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem('userActions'); // Clear user actions too
    navigate('/');
  };
      ...
      <div className={`sidebar ${menuOpen ? 'open' : ''}`}>
        <ul>
          ...
          <li className="contact-support">
            Contact Support<br />
            Email: recipenest.support@gmail.com<br />
            Tel: +233 123456789
          </li>
        </ul>
      </div>
          ...
          <section className="chefs-section">
            ...
            <div className="chef-carousel-wrapper">
              ...
              <div className="chef-carousel">
                {chefs.length > 0 ? (
                  <Link to={`/chef/${chefs[currentIndex].chefId}/view`} className="chef-link">
            ...
            <div className="chef-carousel-wrapper">
              ...
              <div className="chef-carousel">
                {topLikedChefs.length > 0 ? (
                  <Link to={`/chef/${topLikedChefs[topChefIndex].chefId}/view`} className="chef-link">
                    <div className="chef-item">
                      <img
          ...
          <div className="chef-modal">
            <div className="chef-modal-content">
              ...
              <div className="chef-grid">
                {chefs.length > 0 ? (
                  chefs.map((chef) => (
                    <Link to={`/chef/${chef.chefId}/view`} className="chef-link" key={chef.chefId}>
                      <div className="chef-item">
                        <img
